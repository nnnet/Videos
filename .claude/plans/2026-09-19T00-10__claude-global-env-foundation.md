...
Закрыто пятнадцать узлов: **A1, A2, A3, B1, B2, B3, B4, C1, C3, D1, D2,
D3, G1, G2, G4**. Событийный слой работает на живых данных этой сессии;
...
|---|---|---|
| D4 `spec-gate` | агент | нет — следующий |
