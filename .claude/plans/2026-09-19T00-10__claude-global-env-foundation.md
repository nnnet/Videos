...
|---|---|---|
| D5 `sdd-skill` | агент | нет — следующий; зона `ViralMint/.claude/skills/` ни с кем не пересекается |
| F1 `decision-capture` | агент | нет — зона `.repowise/config.yaml` освободилась с закрытием C1 |
